...
import 'package:uni/view/Pages/sup_main_page_view.dart';
import 'package:uni/view/Pages/sup_subject_page_view.dart';
            ...
            switch (settings.name) {
              ...
              case '/' + Constants.navBugReport:
                return PageTransition.makePageTransition(
                    ...
                    settings: settings,
                    maintainState: false);
              case '/' + Constants.navSUP:
                return PageTransition.makePageTransition(
                    page: SupMainPageView(), settings: settings);
              case '/' + Constants.navSUPSubjects:
                return PageTransition.makePageTransition(
                    page: SupSubjectPageView(), settings: settings);
