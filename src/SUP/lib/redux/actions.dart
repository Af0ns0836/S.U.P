...
class UpdateChoosenCoursesCards {
  List<FAVORITE_WIDGET_TYPE> choosenCoursesCards;
  UpdateChoosenCoursesCards(this.choosenCoursesCards);
}
...
class SetSUPHomePageEditingMode {
  bool state;
  SetSUPHomePageEditingMode(this.state);
}

class SetSUPsubjectsPageEditingMode {
  bool state;
  SetSUPsubjectsPageEditingMode(this.state);
}

class SetCourseToView {
  Course course;
  SetCourseToView(this.course);
}

class SetCardEditingMode{
  bool state;
  SetCardEditingMode(this.state);
}
...
class SetSUPSubjectPageEditingMode{
  bool state;
  SetSUPSubjectPageEditingMode(this.state);
}
